...
`
      ...
      .setAuthor(`🤍SECURITY❤️`, bot.user.avatarURL)
      .setFooter(`🤍SECURITY❤️ | Coded by POMMES.`, bot.user.avatarURL);
...
bot.on("message", message => {
  if (message.content === "p!about") {
    const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setAuthor(message.guild.name, message.guild.iconURL).setDescription(`
𝗡𝗮𝗺𝗲
...
bot.on("ready", () => {
  console.log(`Online In Servers : ${bot.guilds.size} | `);
  let statuses = [
...
bot.on("message", message => {
  if (message.content.startsWith(prefix + "antibots on")) {
    ...
    message.channel.send(` **enabled** anti bot🟢!`);
...
bot.on("message", message => {
  if (message.content.startsWith(prefix + "antibots off")) {
    ...
    message.channel.send(` disabled anti bot🔴!`);
    fs.writeFile("./antibot.json", JSON.stringify(antibots), err => {
      if (err)
        console.error(err).catch(err => {
          console.error(err);
...
bot.on("message", message => {
  if (message.content === "p!invite") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setURL(
        "https://discord.com/api/oauth2/authorize?client_id=741746163346309200&permissions=8&redirect_uri=http%3A%2F%2Flocalhost%3A4200%2Fauth&scope=bot"
...
bot.on("message", message => {
  ...
  if (message.content === "p!lock") {
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES"))
      return message.reply(
        "<a:righth:759903066563543090> Sorry you don't have `MANAGE MESSAGES` permissions"
      );
    message.channel
...
bot.on("message", message => {
  ...
  if (message.content === prefix + "help") {
    let embed = new Discord.RichEmbed()
      .setColor("BLACK")
      .setTitle("Choose From The Reactions :").setDescription(`
=====================
 ->> Secuirty Commands
=====================
 ->> Admin Commands
...
bot.on("message", async message => {
  if (message.content === "p!verify") {
    let embed = new Discord.RichEmbed()
      .setDescription("🤍SECURITY❤️ vote !!! ✅ ")
      .setColor("RANDOM")
      .setTimestamp();
...
bot.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "id")) {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField(
        "**کاتی دروستکردنی ئەکاونت | 📆 **: ",
        year + "-" + month + "-" + day
      )
      .addField(
        "**کاتی هاتنەناو سێرڤەر| ⌚   :**",
        message.member.joinedAt.toLocaleString()
      )

      .addField(
        "**⌚ | هەموو کاتی دروستکردنی ئەکاونت :**",
    ...
    if (!message)
      return message
        .reply("**Apply the Minshan correctly  ❌ **")
        .catch(console.error);
  }
});
...
bot.on("message", message => {
  if (message.content.startsWith("p!server")) {
    ...
    var embed = new Discord.RichEmbed()
      ...
      .setImage(
        "https://images-ext-1.discordapp.net/external/X_syLvXWLYCgoMewR0Srx10YmKBExi5eCcC_eMgdQwY/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/503678186521886720/7a8ecabdb8a1e1689d01a958f59a2c1f.png"
      )
